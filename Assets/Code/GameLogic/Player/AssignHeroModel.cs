...
namespace Game.Logic {
	...
	public class AssignHeroModel {
		...
		public AssignHeroCostInfo AssignHeroCost(SharedGameConfig gameConfig) {
			if (!gameConfig.AssignHeroCosts.ContainsKey(CurrentIndex)) {
				return gameConfig.AssignHeroCosts[gameConfig.AssignHeroCosts.Count];
			}

			return gameConfig.AssignHeroCosts[CurrentIndex];
		}
	}
}
