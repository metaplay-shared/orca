	...
	public class ApplicationInstaller : MonoInstaller {
		...
		public override void InstallBindings() {
			...
			Container.BindInterfacesTo<CloudCurtainsPresenter>()
				.FromInstance(FindFirstObjectByType<CloudCurtainsPresenter>(FindObjectsInactive.Include))
				.AsSingle();
			Container.Bind<ApplicationInfo>().AsSingle();
			Container.BindInterfacesTo<UnhealthyConnectionIndicator>()
				.FromInstance(FindFirstObjectByType<UnhealthyConnectionIndicator>(FindObjectsInactive.Include))
				.AsSingle();
