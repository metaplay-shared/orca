	...
	public class ForcedUpdatePopup : MonoBehaviour {
		...
		private static string GetStoreURL() {
			return UnityEngine.Application.platform switch {
				RuntimePlatform.Android      => "https://play.google.com/store/apps/details?id=com.skunkworksgames.orca",
				RuntimePlatform.IPhonePlayer => "https://apps.apple.com/app/id1641736490",
				_                            => ""
			};
		}
